...
class Enum(object):
    ...
    def _exception(self, *args):
        raise EnumImmutableError(args[0])

    __setattr__ = _exception
    __delattr__ = _exception
    __setitem__ = _exception
    __delitem__ = _exception
    __getitem__ = lambda self, i: self._value[i]
    __len__     = lambda self: len(self._value)
